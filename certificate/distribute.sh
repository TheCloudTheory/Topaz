...
DESTINATIONS=(
  ...
  "$SCRIPT_DIR/../Tests/Topaz.Tests.Isolated"
  "$SCRIPT_DIR/../Tests/Topaz.Tests.AzureCLI"
  "$SCRIPT_DIR/../Tests/Topaz.Tests.AzurePowerShell"
  "$SCRIPT_DIR/../Tests/Topaz.Tests.Python"
  "$SCRIPT_DIR/../Tests/Topaz.Tests.NodeJS"
  "$SCRIPT_DIR/../Tests/Topaz.Tests.Terraform"
