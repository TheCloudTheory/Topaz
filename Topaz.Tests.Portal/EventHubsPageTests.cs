...
[TestFixture]
public class EventHubsPageEmptyListTests : BunitTestContext
{
...
[TestFixture]
public class EventHubsPageWithNamespacesTests : BunitTestContext
{
    private ITopazClient _client = null!;
...
[TestFixture]
public class EventHubsPageCreateTests : BunitTestContext
{
    private ITopazClient _client = null!;
    ...
    public async Task EventHubsPage_CreatePanel_CreatesAndRefreshesNamespaceList()
    {
        ...
        await cut.FindAll("select")[1].ChangeAsync("rg1");

        // Fill in namespace name
        await cut.Find("input[placeholder='e.g. my-eventhub-namespace']").ChangeAsync(namespaceName);
