...
public class LogAnalyticsTests : TopazFixture
{
    ...
    {
        await RunAzureCliCommand($"az group create -l westeurope -n {ResourceGroup}-ids");
        await RunAzureCliCommand(
    ...
    {
        await RunAzureCliCommand($"az group create -l westeurope -n {ResourceGroup}-del");
        await RunAzureCliCommand(
    ...
    {
        await RunAzureCliCommand($"az group create -l westeurope -n {ResourceGroup}-list");
        await RunAzureCliCommand(
    ...
    {
        await RunAzureCliCommand($"az group create -l westeurope -n {ResourceGroup}-update");
        await RunAzureCliCommand(
    ...
    {
        await RunAzureCliCommand($"az group create -l westeurope -n {ResourceGroup}-tags");
        await RunAzureCliCommand(
