...
public abstract class PowerShellTestBase
{
    ...
    public async Task FixtureSetUp()
    {
        ...
        _containerTopaz = new ContainerBuilder()
            ...
            .WithPortBinding(8890, assignRandomHostPort: true)
            .WithPortBinding(8899, assignRandomHostPort: true)
            .WithPortBinding(8898, assignRandomHostPort: true)
            .WithPortBinding(8897, assignRandomHostPort: true)
            .WithPortBinding(8891, assignRandomHostPort: true)
            .WithPortBinding(8893, assignRandomHostPort: true)
