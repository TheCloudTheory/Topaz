...
public sealed class ListResourceGroupCommand(HttpClient httpClient) : TopazHttpCommand<ListResourceGroupCommand.ListResourceGroupCommandSettings>(httpClient)
{
