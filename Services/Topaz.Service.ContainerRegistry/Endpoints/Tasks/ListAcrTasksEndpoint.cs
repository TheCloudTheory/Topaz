...
internal sealed class ListAcrTasksEndpoint(Pipeline eventPipeline, ITopazLogger logger) : IEndpointDefinition
{
    ...
    public string[] Permissions => ["Microsoft.ContainerRegistry/registries/tasks/read"];
    ...
    public void GetResponse(HttpContext context, HttpResponseMessage response, GlobalOptions options)
    {
        ...
        var operation = _controlPlane.ListTasks(
        ...
        var result = new ListAcrTasksResponse { Value = operation.Resource! };
