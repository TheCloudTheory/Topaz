...
internal sealed class GetSqlServerConnectionPolicyEndpoint(Pipeline eventPipeline, ITopazLogger logger)
    : IEndpointDefinition
{
    ...
    public string[] Permissions => ["Microsoft.Sql/servers/connectionPolicies/read"];
    ...
    {
        logger.LogDebug(nameof(GetSqlServerConnectionPolicyEndpoint), nameof(GetResponse),
        ...
        try
        {
            ...
            var result = _controlPlane.GetConnectionPolicy(
