...
internal sealed class CreateOrUpdateDatabaseBackupLongTermRetentionPolicyEndpoint : IEndpointDefinition
{
    ...
    public string[] Permissions => ["Microsoft.Sql/servers/databases/backupLongTermRetentionPolicies/write"];
    ...
    public void GetResponse(HttpContext context, HttpResponseMessage response, GlobalOptions options)
    {
        ...
        var result = BackupLongTermRetentionPolicyResponse.ForDatabase(
