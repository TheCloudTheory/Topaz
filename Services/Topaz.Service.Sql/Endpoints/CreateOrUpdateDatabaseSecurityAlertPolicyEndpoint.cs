...
internal sealed class CreateOrUpdateDatabaseSecurityAlertPolicyEndpoint : IEndpointDefinition
{
    public string? ProviderNamespace => "Microsoft.Sql";

    public string[] Endpoints =>
    [
        "PUT /subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Sql/servers/{serverName}/databases/{databaseName}/securityAlertPolicies/{policyName}"
    ];

    public string[] Permissions => ["Microsoft.Sql/servers/databases/securityAlertPolicies/write"];
    ...
    public void GetResponse(HttpContext context, HttpResponseMessage response, GlobalOptions options)
    {
        ...
        var result = DatabaseSecurityAlertPolicyResponse.ForDatabase(
