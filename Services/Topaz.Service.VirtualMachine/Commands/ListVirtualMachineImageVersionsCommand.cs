...
{
    public override async Task<int> ExecuteAsync(CommandContext context, ListVirtualMachineImageVersionsCommandSettings settings)
    {
    ...
    public override ValidationResult Validate(CommandContext context, ListVirtualMachineImageVersionsCommandSettings settings)
    {
