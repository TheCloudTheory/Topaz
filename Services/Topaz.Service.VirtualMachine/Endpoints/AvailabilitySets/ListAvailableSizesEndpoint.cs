...
internal sealed class ListAvailableSizesEndpoint(Pipeline eventPipeline, ITopazLogger logger)
    : IEndpointDefinition
{
    ...
    public void GetResponse(HttpContext context, HttpResponseMessage response, GlobalOptions options)
    {
        ...
        var result = _controlPlane.ListAvailableSizes(
        ...
        response.CreateJsonContentResponse(VirtualMachineSizeListResultResponse.From(result.Resource));
    }
}