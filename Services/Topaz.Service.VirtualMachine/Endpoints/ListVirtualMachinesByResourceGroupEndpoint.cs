...
internal sealed class ListVirtualMachinesByResourceGroupEndpoint(Pipeline eventPipeline, ITopazLogger logger)
    : IEndpointDefinition
{
    ...
    {
        logger.LogDebug(nameof(ListVirtualMachinesByResourceGroupEndpoint), nameof(GetResponse),
        ...
        try
        {
            ...
            var vms = _controlPlane.ListByResourceGroup(subscriptionIdentifier, resourceGroupIdentifier);
