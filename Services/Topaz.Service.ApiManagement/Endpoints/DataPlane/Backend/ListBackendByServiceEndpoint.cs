...
internal sealed class ListBackendByServiceEndpoint(Pipeline eventPipeline, ITopazLogger logger)
    : IEndpointDefinition
{
    ...
    public void GetResponse(HttpContext context, HttpResponseMessage response, GlobalOptions options)
    {
        ...
        response.CreateJsonContentResponse(ApiManagementListBackendsResponse.From(result.Resource));
    }
}