...
internal sealed class DeletePolicyEndpoint(Pipeline eventPipeline, ITopazLogger logger)
    : IEndpointDefinition
{
    ...
    public string[] Permissions => ["Microsoft.ApiManagement/service/policies/delete"];
    ...
    public void GetResponse(HttpContext context, HttpResponseMessage response, GlobalOptions options)
    {
        ...
        var result = _controlPlane.Delete(sub, rg, name, apiId, ifMatch);
