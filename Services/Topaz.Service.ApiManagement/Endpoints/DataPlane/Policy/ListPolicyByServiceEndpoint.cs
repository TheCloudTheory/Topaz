...
internal sealed class ListPolicyByServiceEndpoint(Pipeline eventPipeline, ITopazLogger logger)
    : IEndpointDefinition
{
    ...
    public void GetResponse(HttpContext context, HttpResponseMessage response, GlobalOptions options)
    {
        ...
        response.CreateJsonContentResponse(ApiManagementListPolicyResponse.From(result.Resource));
    }
}