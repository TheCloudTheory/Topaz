...
internal sealed class GetDelegationSettingsEndpoint(Pipeline eventPipeline, ITopazLogger logger)
    : IEndpointDefinition
{
    ...
    public string[] Permissions => ["Microsoft.ApiManagement/service/portalsettings/read"];
    ...
    public void GetResponse(HttpContext context, HttpResponseMessage response, GlobalOptions options)
    {
        ...
        var result = _controlPlane.GetDelegationSettings(sub, rg, name);
