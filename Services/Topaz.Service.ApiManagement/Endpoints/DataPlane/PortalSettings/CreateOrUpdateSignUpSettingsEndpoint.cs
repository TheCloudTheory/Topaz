...
internal sealed class CreateOrUpdateSignUpSettingsEndpoint(Pipeline eventPipeline, ITopazLogger logger)
    : IEndpointDefinition
{
    ...
    public void GetResponse(HttpContext context, HttpResponseMessage response, GlobalOptions options)
    {
        ...
        var request =
            JsonSerializer.Deserialize<CreateOrUpdatePortalSignUpSettingsRequest>(reader.ReadToEnd(),
        ...
        var result = _controlPlane.CreateOrUpdateSignUpSettings(sub, rg, name, request, ifMatch);
