...
internal sealed class CreateOrUpdateSignInSettingsEndpoint(Pipeline eventPipeline, ITopazLogger logger)
    : IEndpointDefinition
{
    ...
    public void GetResponse(HttpContext context, HttpResponseMessage response, GlobalOptions options)
    {
        ...
        var request =
            JsonSerializer.Deserialize<CreateOrUpdatePortalSignInSettingsRequest>(reader.ReadToEnd(),
        ...
        var result = _controlPlane.CreateOrUpdateSignInSettings(sub, rg, name, request, ifMatch);
