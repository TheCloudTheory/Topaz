...
internal sealed class CreateOrUpdateDelegationSettingsEndpoint(Pipeline eventPipeline, ITopazLogger logger)
    : IEndpointDefinition
{
    ...
    public void GetResponse(HttpContext context, HttpResponseMessage response, GlobalOptions options)
    {
        ...
        var request =
            JsonSerializer.Deserialize<CreateOrUpdatePortalDelegationSettingsRequest>(reader.ReadToEnd(),
        ...
        var result = _controlPlane.CreateOrUpdateDelegationSettings(sub, rg, name, request, ifMatch);
