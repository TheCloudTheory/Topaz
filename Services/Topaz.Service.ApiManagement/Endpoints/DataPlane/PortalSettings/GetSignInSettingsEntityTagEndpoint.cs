...
internal sealed class GetSignInSettingsEntityTagEndpoint(Pipeline eventPipeline, ITopazLogger logger)
    : IEndpointDefinition
{
    ...
    public void GetResponse(HttpContext context, HttpResponseMessage response, GlobalOptions options)
    {
        ...
        var result = _controlPlane.GetSignInSettingsEntityTag(sub, rg, name);
