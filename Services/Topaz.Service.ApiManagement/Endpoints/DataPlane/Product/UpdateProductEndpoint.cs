...
internal sealed class UpdateProductEndpoint(Pipeline eventPipeline, ITopazLogger logger)
    : IEndpointDefinition
{
    ...
    public void GetResponse(HttpContext context, HttpResponseMessage response, GlobalOptions options)
    {
        ...
        var result = _controlPlane.Update(sub, rg, name, productId, request, ifMatch);
