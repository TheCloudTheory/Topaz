...
[UsedImplicitly]
[CommandDefinition("apim backend update", "api-management", "Updates a backend in an Azure API Management service.")]
[CommandExample("Updates a backend URL",
...
internal sealed class UpdateBackendCommand(HttpClient httpClient, DefaultsProvider provider)
    : TopazHttpCommand<UpdateBackendCommand.UpdateBackendCommandSettings>(httpClient)
{
    protected override async Task<int> ExecuteAsync(CommandContext context, UpdateBackendCommandSettings settings, CancellationToken cancellationToken)
    {
    ...
    protected override ValidationResult Validate(CommandContext context, UpdateBackendCommandSettings settings)
    {
    ...
    [UsedImplicitly]
    public sealed class UpdateBackendCommandSettings : CommandSettings
    {
