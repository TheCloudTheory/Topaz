...
[UsedImplicitly]
[CommandDefinition("apim policy get-entity-tag", "api-management", "Gets the entity tag (ETag) for a policy in an Azure API Management service.")]
[CommandExample("Gets the ETag for a policy",
    "topaz apim policy get-entity-tag --subscription-id 36a28ebb-9370-46d8-981c-84efe02048ae \\\n    --service-name \"my-apim\" \\\n    --policy-id \"policy\" \\\n    --resource-group \"rg-local\"")]
internal sealed class GetPolicyEntityTagCommand(HttpClient httpClient, DefaultsProvider provider)
    : TopazHttpCommand<GetPolicyEntityTagCommand.GetPolicyEntityTagCommandSettings>(httpClient)
{
    protected override async Task<int> ExecuteAsync(CommandContext context, GetPolicyEntityTagCommandSettings settings, CancellationToken cancellationToken)
    {
    ...
    protected override ValidationResult Validate(CommandContext context, GetPolicyEntityTagCommandSettings settings)
    {
    ...
    [UsedImplicitly]
    public sealed class GetPolicyEntityTagCommandSettings : CommandSettings
    {
