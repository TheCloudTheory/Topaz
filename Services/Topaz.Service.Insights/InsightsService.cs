...
public sealed class InsightsService(Pipeline eventPipeline, ITopazLogger logger) : IServiceDefinition
{
    ...
    [
        ...
        new GetCurrentBillingFeaturesEndpoint(eventPipeline, logger),
        new PutCurrentBillingFeaturesEndpoint(eventPipeline, logger),
        ...
        new QueryEndpoint(eventPipeline, logger)
    ];
}