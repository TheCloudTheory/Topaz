...
internal sealed class DeleteDocumentEndpoint : CosmosDataPlaneEndpointBase
{
    ...
    private DeleteDocumentEndpoint(CosmosDbDataPlane dataPlane, Pipeline eventPipeline, ITopazLogger logger)
    ...
    public override string[] Permissions => ["Microsoft.DocumentDB/databaseAccounts/sqlDatabases/containers/items/delete"];
