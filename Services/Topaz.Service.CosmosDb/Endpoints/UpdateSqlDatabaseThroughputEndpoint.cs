...
internal sealed class UpdateSqlDatabaseThroughputEndpoint(Pipeline eventPipeline, ITopazLogger logger)
    : IEndpointDefinition
{
    ...
    public string[] Permissions => ["Microsoft.DocumentDB/databaseAccounts/sqlDatabases/throughputSettings/write"];
    ...
    public void GetResponse(HttpContext context, HttpResponseMessage response, GlobalOptions options)
    {
        ...
        var request = JsonSerializer.Deserialize<UpdateSqlDatabaseThroughputRequest>(content, GlobalSettings.JsonOptions);
        if (request == null)
        {
        ...
        var operation = _controlPlane.UpdateSqlDatabaseThroughput(
