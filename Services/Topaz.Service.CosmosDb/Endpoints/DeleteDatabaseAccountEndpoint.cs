...
internal sealed class DeleteDatabaseAccountEndpoint(Pipeline eventPipeline, ITopazLogger logger)
    : IEndpointDefinition
{
    ...
    public string[] Permissions => ["Microsoft.DocumentDB/databaseAccounts/delete"];
    ...
    {
        logger.LogDebug(nameof(DeleteDatabaseAccountEndpoint), nameof(GetResponse),
        ...
        try
        {
            ...
            var result = _controlPlane.Delete(subscriptionIdentifier, resourceGroupIdentifier, accountName);
