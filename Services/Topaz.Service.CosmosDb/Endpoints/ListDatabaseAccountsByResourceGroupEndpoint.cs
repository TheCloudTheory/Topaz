...
internal sealed class ListDatabaseAccountsByResourceGroupEndpoint(Pipeline eventPipeline, ITopazLogger logger)
    : IEndpointDefinition
{
    ...
    {
        logger.LogDebug(nameof(ListDatabaseAccountsByResourceGroupEndpoint), nameof(GetResponse),
