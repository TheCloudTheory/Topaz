...
[UsedImplicitly]
[CommandDefinition("appconfig replica show", "app-configuration", "Gets a replica of an App Configuration store.")]
[CommandExample("Show a replica",
    "topaz appconfig replica show --name \"my-appconfig\" --replica-name \"my-replica\" --resource-group \"rg-local\" --subscription-id 36a28ebb-9370-46d8-981c-84efe02048ae")]
internal sealed class GetReplicaCommand(HttpClient httpClient, DefaultsProvider provider)
    : TopazHttpCommand<GetReplicaCommand.Settings>(httpClient)
{
