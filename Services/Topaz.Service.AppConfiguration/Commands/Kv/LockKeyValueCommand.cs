...
[UsedImplicitly]
[CommandDefinition("appconfig kv lock", "app-configuration", "Locks (makes read-only) a key-value in an App Configuration store.")]
[CommandExample("Lock a key-value",
    "topaz appconfig kv lock --name \"my-appconfig\" --key \"MyApp:Settings:FontSize\"")]
internal sealed class LockKeyValueCommand(HttpClient httpClient)
    : TopazHttpCommand<LockKeyValueCommand.Settings>(httpClient)
{
