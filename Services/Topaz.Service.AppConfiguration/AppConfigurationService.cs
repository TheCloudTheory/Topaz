...
public sealed class AppConfigurationService(Pipeline eventPipeline, ITopazLogger logger) : IServiceDefinition
{
    ...
    [
        ...
        new CreateReplicaEndpoint(eventPipeline, logger),
        new GetReplicaEndpoint(eventPipeline, logger),
        new DeleteReplicaEndpoint(eventPipeline, logger),
        new ListReplicasByStoreEndpoint(eventPipeline, logger),
        ...
        new CheckSnapshotEndpoint(eventPipeline, logger),
        new CheckSnapshotsEndpoint(eventPipeline, logger)
    ];
}
