...
internal sealed class GetDeletedStoreEndpoint(Pipeline eventPipeline, ITopazLogger logger) : IEndpointDefinition
{
    ...
    [
        "GET /subscriptions/{subscriptionId}/providers/Microsoft.AppConfiguration/locations/{location}/deletedConfigurationStores/{storeName}"
    ];
    ...
    public void GetResponse(HttpContext context, HttpResponseMessage response, GlobalOptions options)
    {
        ...
        if (deleted.Result == OperationResult.NotFound || deleted.Resource == null)
        {
            response.StatusCode = HttpStatusCode.NotFound;
            return;
        }
        
        response.CreateJsonContentResponse(DeletedConfigurationStore.From(deleted.Resource));
    }
}