...
internal sealed class ListKeysServiceBusQueueAuthorizationRuleEndpoint(Pipeline eventPipeline, ITopazLogger logger)
    : IEndpointDefinition
{
    ...
    public string[] Endpoints => ["POST /subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ServiceBus/namespaces/{namespaceName}/queues/{queueName}/authorizationRules/{authorizationRuleName}/listKeys"];
    public string[] Permissions => ["Microsoft.ServiceBus/namespaces/queues/authorizationRules/listKeys/action"];
    ...
    public void GetResponse(HttpContext context, HttpResponseMessage response, GlobalOptions options)
    {
        ...
        var operation = _controlPlane.ListQueueAuthorizationRuleKeys(sub, rg, ns, queueName, ruleName);
