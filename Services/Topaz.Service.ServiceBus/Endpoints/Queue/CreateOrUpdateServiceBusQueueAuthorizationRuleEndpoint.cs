...
internal sealed class CreateOrUpdateServiceBusQueueAuthorizationRuleEndpoint(Pipeline eventPipeline, ITopazLogger logger)
    : IEndpointDefinition
{
    ...
    public string[] Endpoints => ["PUT /subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ServiceBus/namespaces/{namespaceName}/queues/{queueName}/authorizationRules/{authorizationRuleName}"];
    public string[] Permissions => ["Microsoft.ServiceBus/namespaces/queues/authorizationRules/write"];
