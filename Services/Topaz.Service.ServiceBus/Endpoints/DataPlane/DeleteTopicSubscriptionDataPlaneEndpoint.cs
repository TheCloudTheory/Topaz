...
internal sealed class DeleteTopicSubscriptionDataPlaneEndpoint(Pipeline eventPipeline, ITopazLogger logger) : IEndpointDefinition
{
    ...
    public string[] Endpoints => ["DELETE /{entity}/{messageType}/Subscriptions/{subscription}"];
    public string[] Permissions => ["Microsoft.ServiceBus/namespaces/topics/subscriptions/delete"];
