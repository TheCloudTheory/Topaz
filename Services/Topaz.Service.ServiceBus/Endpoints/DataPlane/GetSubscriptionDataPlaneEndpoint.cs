...
internal sealed class GetSubscriptionDataPlaneEndpoint(Pipeline eventPipeline, ITopazLogger logger) : IEndpointDefinition
{
    ...
    public string[] Endpoints => ["GET /{entity}/Subscriptions/{subscription}"];
