...
internal sealed class CreateOrUpdateTopicSubscriptionDataPlaneEndpoint(Pipeline eventPipeline, ITopazLogger logger) : IEndpointDefinition
{
    ...
    public string[] Endpoints => ["PUT /{entity}/{messageType}/Subscriptions/{subscription}"];
    ...
    public void GetResponse(HttpContext context, HttpResponseMessage response, GlobalOptions options)
    {
        ...
        var subscriptionName = context.Request.Path.Value.ExtractValueFromPath(4);
        ...
        var operation = _controlPlane.CreateOrUpdateSubscription(subscriptionId!, resourceGroupId!, namespaceName, subscriptionName!, CreateOrUpdateServiceBusSubscriptionRequest.From(atomRequest));
