...
internal sealed class GetRuleDataPlaneEndpoint(Pipeline eventPipeline, ITopazLogger logger) : IEndpointDefinition
{
    ...
    public string[] Endpoints => ["GET /{entity}/Subscriptions/{subscription}/Rules/{ruleName}"];
    ...
    public void GetResponse(HttpContext context, HttpResponseMessage response, GlobalOptions options)
    {
        ...
        var operation = _controlPlane.GetRule(subscriptionId!, resourceGroupId!, namespaceName, topicName, subscriptionName, ruleName);
