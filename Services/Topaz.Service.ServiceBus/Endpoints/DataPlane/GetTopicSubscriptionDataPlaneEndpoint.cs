...
internal sealed class GetTopicSubscriptionDataPlaneEndpoint(Pipeline eventPipeline, ITopazLogger logger) : IEndpointDefinition
{
    ...
    public string[] Endpoints => ["GET /{entity}/{messageType}/Subscriptions/{subscription}"];
