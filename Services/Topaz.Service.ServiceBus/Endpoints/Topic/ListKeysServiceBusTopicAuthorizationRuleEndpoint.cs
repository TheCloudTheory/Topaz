...
internal sealed class ListKeysServiceBusTopicAuthorizationRuleEndpoint(Pipeline eventPipeline, ITopazLogger logger)
    : IEndpointDefinition
{
    ...
    public string[] Endpoints => ["POST /subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ServiceBus/namespaces/{namespaceName}/topics/{topicName}/authorizationRules/{authorizationRuleName}/listKeys"];
    public string[] Permissions => ["Microsoft.ServiceBus/namespaces/topics/authorizationRules/listKeys/action"];
    ...
    public void GetResponse(HttpContext context, HttpResponseMessage response, GlobalOptions options)
    {
        ...
        var operation = _controlPlane.ListTopicAuthorizationRuleKeys(sub, rg, ns, topicName, ruleName);
