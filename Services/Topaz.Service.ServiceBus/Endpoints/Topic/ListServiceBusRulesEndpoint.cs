...
internal sealed class ListServiceBusRulesEndpoint(Pipeline eventPipeline, ITopazLogger logger)
    : IEndpointDefinition
{
    ...
    public void GetResponse(HttpContext context, HttpResponseMessage response, GlobalOptions options)
    {
        ...
        var operation = _controlPlane.ListRules(subscriptionIdentifier, resourceGroupIdentifier,
        ...
        response.CreateJsonContentResponse(ListServiceBusRulesResponse.From(operation.Resource));
    }
}
