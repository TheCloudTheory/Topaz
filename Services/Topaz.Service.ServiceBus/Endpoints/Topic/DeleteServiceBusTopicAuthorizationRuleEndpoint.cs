...
internal sealed class DeleteServiceBusTopicAuthorizationRuleEndpoint(Pipeline eventPipeline, ITopazLogger logger)
    : IEndpointDefinition
{
    ...
    public string[] Endpoints => ["DELETE /subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ServiceBus/namespaces/{namespaceName}/topics/{topicName}/authorizationRules/{authorizationRuleName}"];
    public string[] Permissions => ["Microsoft.ServiceBus/namespaces/topics/authorizationRules/delete"];
    ...
    public void GetResponse(HttpContext context, HttpResponseMessage response, GlobalOptions options)
    {
        ...
        var operation = _controlPlane.DeleteTopicAuthorizationRule(sub, rg, ns, topicName, ruleName);
