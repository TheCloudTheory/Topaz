...
internal sealed class CreateOrUpdateServiceBusSubscriptionEndpoint(Pipeline eventPipeline, ITopazLogger logger)
    : IEndpointDefinition
{
    ...
    public void GetResponse(HttpContext context, HttpResponseMessage response, GlobalOptions options)
    {
        ...
        var request = JsonSerializer.Deserialize<CreateOrUpdateServiceBusSubscriptionRequest>(content,
