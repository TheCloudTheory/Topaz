...
public sealed class PrivateEndpointResource : ArmResource<PrivateEndpointResourceProperties>
{
    [JsonConstructor]
    ...
    public PrivateEndpointResource(
        ...
        PrivateEndpointResourceProperties properties)
    {
        Id = $"/subscriptions/{subscriptionId}/resourceGroups/{resourceGroup}/providers/Microsoft.Network/privateEndpoints/{name}";
        Name = name;
        Location = location;
