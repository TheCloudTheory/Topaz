...
internal sealed class ListLoadBalancersByResourceGroupEndpoint(Pipeline eventPipeline, ITopazLogger logger) : IEndpointDefinition
{
    ...
    {
        logger.LogDebug(nameof(ListLoadBalancersByResourceGroupEndpoint), nameof(GetResponse), "Executing {0}.", nameof(GetResponse));
        ...
        try
        {
            ...
            var lbs = _controlPlane.ListByResourceGroup(subscriptionIdentifier, resourceGroupIdentifier);
