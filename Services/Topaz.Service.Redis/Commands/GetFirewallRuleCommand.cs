...
[UsedImplicitly]
[CommandDefinition("redis firewall-rule show", "redis", "Gets a firewall rule for an Azure Cache for Redis instance.")]
[CommandExample("Gets a firewall rule for a Redis cache",
    "topaz redis firewall-rule show --subscription-id 36a28ebb-9370-46d8-981c-84efe02048ae \\\n    --name \"my-redis\" \\\n    --resource-group \"rg-local\" \\\n    --rule-name \"allow-office\"")]
internal sealed class GetFirewallRuleCommand(HttpClient httpClient, DefaultsProvider provider)
    : TopazHttpCommand<GetFirewallRuleCommand.Settings>(httpClient)
{
