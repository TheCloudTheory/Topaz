...
[UsedImplicitly]
[CommandDefinition("redis firewall-rule delete", "redis", "Deletes a firewall rule from an Azure Cache for Redis instance.")]
[CommandExample("Deletes a firewall rule from a Redis cache",
    "topaz redis firewall-rule delete --subscription-id 36a28ebb-9370-46d8-981c-84efe02048ae \\\n    --name \"my-redis\" \\\n    --resource-group \"rg-local\" \\\n    --rule-name \"allow-office\"")]
internal sealed class DeleteFirewallRuleCommand(HttpClient httpClient, DefaultsProvider provider)
    : TopazHttpCommand<DeleteFirewallRuleCommand.Settings>(httpClient)
{
    protected override async Task<int> ExecuteAsync(CommandContext context, Settings settings, CancellationToken cancellationToken)
    {
        ...
        AnsiConsole.WriteLine($"Firewall rule '{settings.RuleName}' deleted.");
        return 0;
    }
