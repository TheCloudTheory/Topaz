...
internal sealed class GetAppServiceSiteEndpoint(Pipeline eventPipeline, ITopazLogger logger) : IEndpointDefinition
{
    ...
    [
        "GET /subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Web/sites/{siteName}"
    ];
    ...
    {
        logger.LogDebug(nameof(GetAppServiceSiteEndpoint), nameof(GetResponse), "Executing {0}.", nameof(GetResponse));
        ...
        try
        {
            ...
            var result = _controlPlane.Get(subscriptionIdentifier, resourceGroupIdentifier, siteName!);
