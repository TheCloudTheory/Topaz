...
internal sealed class ListAppServicePlansByResourceGroupEndpoint(Pipeline eventPipeline, ITopazLogger logger)
    : IEndpointDefinition
{
    ...
    {
        logger.LogDebug(nameof(ListAppServicePlansByResourceGroupEndpoint), nameof(GetResponse), "Executing {0}.",
            nameof(GetResponse));
        ...
        try
        {
            ...
            var plans = _controlPlane.ListByResourceGroup(subscriptionIdentifier, resourceGroupIdentifier);
