...
internal sealed class GetEventGridSystemTopicSubscriptionDeliveryAttributesEndpoint(Pipeline eventPipeline, ITopazLogger logger)
    : IEndpointDefinition
{
    ...
    [
        "POST /subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.EventGrid/systemTopics/{topicName}/eventSubscriptions/{eventSubscriptionName}/getDeliveryAttributes"
    ];
