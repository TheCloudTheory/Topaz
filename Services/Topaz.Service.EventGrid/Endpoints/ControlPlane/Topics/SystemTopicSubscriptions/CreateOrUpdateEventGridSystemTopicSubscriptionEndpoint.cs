...
internal sealed class CreateOrUpdateEventGridSystemTopicSubscriptionEndpoint(Pipeline eventPipeline, ITopazLogger logger) : IEndpointDefinition
{
    ...
    [
        "PUT /subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.EventGrid/systemTopics/{topicName}/eventSubscriptions/{eventSubscriptionName}"
    ];
