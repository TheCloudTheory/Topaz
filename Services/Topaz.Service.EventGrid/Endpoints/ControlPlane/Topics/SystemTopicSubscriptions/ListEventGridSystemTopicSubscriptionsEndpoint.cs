...
internal sealed class ListEventGridSystemTopicSubscriptionsEndpoint(Pipeline eventPipeline, ITopazLogger logger)
    : IEndpointDefinition
{
    ...
    [
        "GET /subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.EventGrid/systemTopics/{topicName}/eventSubscriptions"
    ];

    public string[] Permissions => ["Microsoft.EventGrid/systemTopics/eventSubscriptions/read"];
