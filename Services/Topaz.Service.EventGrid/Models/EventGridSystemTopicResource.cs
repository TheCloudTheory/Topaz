...
internal sealed class EventGridSystemTopicResource : ArmResource<EventGridSystemTopicResourceProperties>, IValidatable
{
    [UsedImplicitly]
    public EventGridSystemTopicResource()
    {
    }
    ...
    public EventGridSystemTopicResource(
        ...
        EventGridSystemTopicResourceProperties properties)
    {
        Id = $"/subscriptions/{subscriptionId}/resourceGroups/{resourceGroup}/providers/Microsoft.EventGrid/systemTopics/{name}";
        Name = name;
        Location = location;
    ...
    public override EventGridSystemTopicResourceProperties Properties { get; init; } = new();
    ...
    public void UpdateFromRequest(EventGridSystemTopicResource request)
    {
