...
public sealed class RegisterResourceProviderEndpoint(Pipeline eventPipeline, ITopazLogger logger) : IEndpointDefinition
{
    ...
    [
        "POST /subscriptions/{subscriptionId}/providers/{providerNamespace}/register"
    ];

    public string[] Permissions => ["*/register/action"];
    ...
    public void GetResponse(HttpContext context, HttpResponseMessage response, GlobalOptions options)
    {
        ...
        _resourceProvider.SetProviderRegistrationState(
            subscriptionIdentifier.Value, providerNamespace, ResourceProviderDataResponse.RegisteredState);
        ...
        var data = new ResourceProviderDataResponse(providerNamespace)
        {
            ...
            RegistrationState = ResourceProviderDataResponse.RegisteredState,
