...
using Topaz.Service.KeyVault.Models.Responses.Vault;
...
internal sealed class CheckMhsmNameAvailabilityEndpoint(Pipeline eventPipeline, ITopazLogger logger)
    : IEndpointDefinition
{
    ...
    public string[] Permissions => ["Microsoft.KeyVault/checkMhsmNameAvailability/read"];
    ...
    {
        logger.LogDebug(nameof(CheckMhsmNameAvailabilityEndpoint), nameof(GetResponse), "Executing {0}.",
            nameof(GetResponse));
