...
public sealed class RestoreKeyEndpoint(Pipeline eventPipeline, ITopazLogger logger) : IEndpointDefinition
{
    ...
    public string[] Endpoints => ["POST /keys/{keyName}/restore"];
