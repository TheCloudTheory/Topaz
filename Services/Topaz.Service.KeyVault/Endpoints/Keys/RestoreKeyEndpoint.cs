...
internal sealed class RestoreKeyEndpoint(Pipeline eventPipeline, ITopazLogger logger) : KeyVaultDataPlaneEndpointBase(eventPipeline, logger), IEndpointDefinition
{
    ...
    public string[] Endpoints => ["POST /keys/restore"];

    public string[] Permissions => ["Microsoft.KeyVault/vaults/keys/restore/action"];
    ...
    public void GetResponse(HttpContext context, HttpResponseMessage response, GlobalOptions options)
    {
        try
        {
            ...
            var operation = _dataPlane.RestoreKeyBackup(context.Request.Body,
