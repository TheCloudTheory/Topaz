...
public sealed class EncryptKeyEndpoint(Pipeline eventPipeline, ITopazLogger logger) : IEndpointDefinition
{
    ...
    public void GetResponse(HttpContext context, HttpResponseMessage response, GlobalOptions options)
    {
        try
        {
            ...
            if (!_authChecker.IsAuthorized(authHeader, kvResult.Resource, Permissions, "encrypt", "keys"))
            {
