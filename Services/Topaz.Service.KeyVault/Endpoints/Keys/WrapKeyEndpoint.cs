...
internal sealed class WrapKeyEndpoint(Pipeline eventPipeline, ITopazLogger logger) : KeyVaultDataPlaneEndpointBase(eventPipeline, logger), IEndpointDefinition
{
    ...
    protected override string? AccessPolicyPermission => "wrapKey";
