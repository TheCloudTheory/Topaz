...
internal sealed class VerifyKeyEndpoint(Pipeline eventPipeline, ITopazLogger logger) : KeyVaultDataPlaneEndpointBase(eventPipeline, logger), IEndpointDefinition
{
    ...
    protected override string? AccessPolicyPermission => "verify";
