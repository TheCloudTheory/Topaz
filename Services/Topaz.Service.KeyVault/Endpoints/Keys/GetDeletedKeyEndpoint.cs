...
internal sealed class GetDeletedKeyEndpoint(Pipeline eventPipeline, ITopazLogger logger) : KeyVaultDataPlaneEndpointBase(eventPipeline, logger), IEndpointDefinition
{
    ...
    public string[] Endpoints => ["GET /deletedkeys/{keyName}"];
    ...
    public void GetResponse(HttpContext context, HttpResponseMessage response, GlobalOptions options)
    {
        try
        {
            ...
            var operation = _dataPlane.GetDeletedKey(subscriptionIdentifier, resourceGroupIdentifier,
                vaultName!, keyName);
            ...
            var content = GetDeletedKeyResponse.FromRecord(operation.Resource, vaultName!);
