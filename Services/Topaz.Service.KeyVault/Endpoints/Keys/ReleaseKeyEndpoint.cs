...
public sealed class ReleaseKeyEndpoint(Pipeline eventPipeline, ITopazLogger logger) : IEndpointDefinition
{
    ...
    public void GetResponse(HttpContext context, HttpResponseMessage response, GlobalOptions options)
    {
        try
        {
            ...
            if (!_authChecker.IsAuthorized(authHeader, kvResult.Resource, Permissions, "release", "keys"))
            {
