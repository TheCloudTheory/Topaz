...
internal sealed class RotateKeyEndpoint(Pipeline eventPipeline, ITopazLogger logger) : KeyVaultDataPlaneEndpointBase(eventPipeline, logger), IEndpointDefinition
{
    ...
    protected override string? AccessPolicyPermission => "rotate";
