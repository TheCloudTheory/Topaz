...
internal sealed class GetCertificateVersionsEndpoint(Pipeline eventPipeline, ITopazLogger logger)
    : KeyVaultDataPlaneEndpointBase(eventPipeline, logger), IEndpointDefinition
{
    ...
    public string[] Endpoints => ["GET /certificates/{certName}/versions"];
    ...
    public void GetResponse(HttpContext context, HttpResponseMessage response, GlobalOptions options)
    {
        try
        {
            ...
            var operation = _dataPlane.GetCertificateVersions(
            ...
            response.CreateJsonContentResponse(GetCertificateVersionsResponse.FromBundles(operation.Resource!));
        }
        catch (Exception ex)
        {
            logger.LogError(ex);
