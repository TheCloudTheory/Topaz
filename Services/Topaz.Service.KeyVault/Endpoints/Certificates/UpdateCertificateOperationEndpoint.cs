...
internal sealed class UpdateCertificateOperationEndpoint(Pipeline eventPipeline, ITopazLogger logger)
    : KeyVaultDataPlaneEndpointBase(eventPipeline, logger), IEndpointDefinition
{
    ...
    public string[] Endpoints => ["PATCH /certificates/{certName}/pending"];
    ...
    public void GetResponse(HttpContext context, HttpResponseMessage response, GlobalOptions options)
    {
        try
        {
            ...
            var result = _dataPlane.UpdateCertificateOperation(context.Request.Body,
