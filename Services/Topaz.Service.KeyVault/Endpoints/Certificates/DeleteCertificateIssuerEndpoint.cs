...
internal sealed class DeleteCertificateIssuerEndpoint(Pipeline eventPipeline, ITopazLogger logger)
    : KeyVaultDataPlaneEndpointBase(eventPipeline, logger), IEndpointDefinition
{
    ...
    public string[] Endpoints => ["DELETE /certificates/issuers/{issuer-name}"];
    public string[] Permissions => ["Microsoft.KeyVault/vaults/certificates/manageissuers/deleteissuers/action"];
    ...
    public void GetResponse(HttpContext context, HttpResponseMessage response, GlobalOptions options)
    {
        try
        {
            ...
            var operation = _dataPlane.DeleteIssuer(
