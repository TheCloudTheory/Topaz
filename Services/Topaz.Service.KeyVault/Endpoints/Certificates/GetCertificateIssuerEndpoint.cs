...
internal sealed class GetCertificateIssuerEndpoint(Pipeline eventPipeline, ITopazLogger logger)
    : KeyVaultDataPlaneEndpointBase(eventPipeline, logger), IEndpointDefinition
{
    ...
    public string[] Endpoints => ["GET /certificates/issuers/{issuer-name}"];
    public string[] Permissions => ["Microsoft.KeyVault/vaults/certificates/manageissuers/getissuers/action"];
    ...
    public void GetResponse(HttpContext context, HttpResponseMessage response, GlobalOptions options)
    {
        try
        {
            ...
            var operation = _dataPlane.GetIssuer(
