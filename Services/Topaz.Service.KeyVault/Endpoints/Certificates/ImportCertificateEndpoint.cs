...
internal sealed class ImportCertificateEndpoint(Pipeline eventPipeline, ITopazLogger logger)
    : KeyVaultDataPlaneEndpointBase(eventPipeline, logger), IEndpointDefinition
{
    ...
    public string[] Endpoints => ["POST /certificates/{certName}/import"];
    public string[] Permissions => ["Microsoft.KeyVault/vaults/certificates/import/action"];
    ...
    public void GetResponse(HttpContext context, HttpResponseMessage response, GlobalOptions options)
    {
        try
        {
            ...
            var operation = _dataPlane.ImportCertificate(context.Request.Body,
