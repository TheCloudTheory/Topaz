...
public class RotateKeyCommand(ITopazLogger logger) : Command<RotateKeyCommand.RotateKeyCommandSettings>
{
    ...
    {
        logger.LogInformation($"Executing {nameof(RotateKeyCommand)}.{nameof(Execute)}.");
    ...
    public override ValidationResult Validate(CommandContext context, RotateKeyCommandSettings settings)
    {
