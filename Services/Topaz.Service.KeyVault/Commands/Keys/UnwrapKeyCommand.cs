...
public class UnwrapKeyCommand(HttpClient httpClient) : TopazHttpCommand<UnwrapKeyCommand.UnwrapKeyCommandSettings>(httpClient)
{
    ...
    protected override async Task<int> ExecuteAsync(CommandContext context, UnwrapKeyCommandSettings settings, CancellationToken cancellationToken)
    {
    ...
    protected override ValidationResult Validate(CommandContext context, UnwrapKeyCommandSettings settings)
    {
