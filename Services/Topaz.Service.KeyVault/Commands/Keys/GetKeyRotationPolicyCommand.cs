...
public class GetKeyRotationPolicyCommand(ITopazLogger logger) : Command<GetKeyRotationPolicyCommand.GetKeyRotationPolicyCommandSettings>
{
    public override int Execute(CommandContext context, GetKeyRotationPolicyCommandSettings settings)
    {
        ...
        var operation = dataPlane.GetKeyRotationPolicy(subscriptionIdentifier, resourceGroupIdentifier,
