...
public class WrapKeyCommand(HttpClient httpClient) : TopazHttpCommand<WrapKeyCommand.WrapKeyCommandSettings>(httpClient)
{
    ...
    protected override async Task<int> ExecuteAsync(CommandContext context, WrapKeyCommandSettings settings, CancellationToken cancellationToken)
    {
    ...
    protected override ValidationResult Validate(CommandContext context, WrapKeyCommandSettings settings)
    {
