...
public class PurgeDeletedSecretCommand(ITopazLogger logger) : Command<PurgeDeletedSecretCommand.PurgeDeletedSecretCommandSettings>
{
    public override int Execute(CommandContext context, PurgeDeletedSecretCommandSettings settings)
    {
        ...
        var operation = dataPlane.PurgeDeletedSecret(subscriptionIdentifier, resourceGroupIdentifier,
